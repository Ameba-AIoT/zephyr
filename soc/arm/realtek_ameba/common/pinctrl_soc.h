...
#ifndef ZEPHYR_SOC_ARM_RTK_AMEBA_COMMON_PINCTRL_SOC_H_
#define ZEPHYR_SOC_ARM_RTK_AMEBA_COMMON_PINCTRL_SOC_H_
...
#endif /* ZEPHYR_SOC_ARM_RTK_AMEBA_COMMON_PINCTRL_SOC_H_ */

...
#ifndef ZEPHYR_SOC_REALTEK_AMEBA_AMEBASMART_PINCTRL_SOC_H_
#define ZEPHYR_SOC_REALTEK_AMEBA_AMEBASMART_PINCTRL_SOC_H_
...
struct pinctrl_soc_pin {
	uint32_t pinmux: 15;
	/* bit[14:13] port (A=0, B=1, C=2)
	 * bit[12:8]  pin number within port
	 * bit[7:0]   PINMUX_FUNCTION_* ID
	 */
...
#endif /* ZEPHYR_SOC_REALTEK_AMEBA_AMEBASMART_PINCTRL_SOC_H_ */

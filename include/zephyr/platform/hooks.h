 ...
 *
 * This hook is implemented by the SoC to perform any hardware-level
 * power-on sequencing required before the PSCI firmware can release
 * the secondary CPU (e.g. assert power rails, release isolation).
 *
 * @param cpu_mpid MPIDR of the CPU to be powered on.
 */

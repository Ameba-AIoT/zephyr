...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_REALTEK_AMEBADPLUS_PINCTRL_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_REALTEK_AMEBADPLUS_PINCTRL_H_
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_REALTEK_AMEBADPLUS_PINCTRL_H_ */

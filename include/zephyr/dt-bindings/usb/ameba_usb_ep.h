...
#define AMEBA_USB_EP_TYPE_NON_CTRL     (AMEBA_USB_EP_TYPE_ISOC | AMEBA_USB_EP_TYPE_BULK | AMEBA_USB_EP_TYPE_INTR)
...
/*
	...
	mps        10:0bit
*/
#define AMEBA_USB_EP(epnum,direction,type,mps)  (((epnum) << 16) | ((direction) << 15) | ((type) << 11) | ((mps) << 0))
